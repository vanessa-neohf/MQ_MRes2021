...
```
Supplementary Figure S3. Time Series of Data Loggers SST data from Australian Institute of Marine Science (AIMS).
```{r Combine_Loggers}
...
Logger_COMBINED <- rbind(SCOTT_RPO_1_Logger, SCOTT_SL4_Logger, SCOTT_SS3_Logger, 
  ...
  mutate(subsite = str_replace(subsite, "SCOTTSL1", "SCOTTSL1(closest to BRS05, BRS07)")) %>% 
  mutate(subsite = str_replace(subsite, "100THSITE", "100THSITE(closest to DAR3, DAR Long)")) %>% 
  mutate(subsite = str_replace(subsite, "TANDFL1", "TANDFL1(closest to 08TNT, 13TNT)")) %>% 
  mutate(subsite = str_replace(subsite, "BUNDFL1", "BUNDFL1(closest to 08BND, 13BND)")) %>% 
  mutate(subsite = str_replace(subsite, "NTHFISHFL1", "NTHFISHFL1(closest to HAB10A, HAB05B)")) %>% 
  rename(`Logger Name` = "subsite")

cols = c("SCOTT_RPO_1" = "black", "SCOTT_SL4" = "black", "SCOTT_SS3" = "black", 
         "SCOTTNR1" = "black", "SCOTTSL1(closest to BRS05, BRS07)" = "black", "SCOTTSL2" = "black", 
         "SCOTTSL3" = "black", "SCOTTSS1" = "black", "SCOTTSS2" = "black", "SCOTT_SS3" = "black", 
         "100THSITE(closest to DAR3, DAR Long)" = "dark blue", "BUNDEGI_BR" = "sky blue", "BUNDFL1(closest to 08BND, 13BND)" = "brown",
         "NTHFISHFL1(closest to HAB10A, HAB05B)" = "dark green", "TANDFL1(closest to 08TNT, 13TNT)" = "light green", "TANTABIDDI_SL1" = "red")

Logger_TS <- ggplot(Logger_COMBINED) +
  geom_line(aes(x = date, y = sst, color = `Logger Name`), position = "jitter") +
  scale_color_manual(values = cols) +
  scale_x_date(limits = (as.Date(c("1997-01-01", "2021-01-01"))), date_breaks = "5 years", date_labels = "%Y") +
  ...
  labs(y = ("Temperature°C"), x = "Time", caption = "Sea Surface Temperature based on in situ loggers")
...
Supplementary Figure S4. Interactive Time Series of SST data from CCI, NOAA, Logger, GCM, and coral core SST calibrated from CCI and NOAA.

```{r Combined_TS, fig.width = 10, fig.height = 7}
...
TS_BRS07 <- Browse_07_comb %>% 
  ...
  theme(legend.title = element_blank(), panel.background = element_blank(), axis.line = element_line("black"), axis.title = element_text(size = 12)) +
  labs(title = "(A) Browse Island BRS07 (-14.12, 123.55)", y = ("Temperature°C"), x = "Time")
...
TS_DARL <- Cocos_DARL_comb %>% 
  ...
  scale_x_date(limits = (as.Date(c("1978-01-01", "2021-01-01"))), date_breaks = "5 years", date_labels = "%Y") +
  theme(legend.title = element_blank(), panel.background = element_blank(), axis.line = element_line("black"), axis.title = element_text(size = 12)) +
  labs(title = "(B) Cocos Keeling Island DARL (-12.09, 96.88)", y = ("Temperature°C"), x = "Time")
...
TS_SCOTT_RPO_1 <- SCOTT_RPO_1_comb %>% 
  ...
  scale_x_date(limits = (as.Date(c("1978-01-01", "2021-01-01"))), date_breaks = "5 years", date_labels = "%Y") +
  theme(legend.title = element_blank(), panel.background = element_blank(), axis.line = element_line("black"), axis.title = element_text(size = 12)) +
  labs(title = "(C) Scott Reef SCOTT_RPO_1 (-14.06, 121.78)", y = ("Temperature°C"), x = "Time")
...
TS_SCOTTSL1 <- SCOTTSL1_comb %>% 
  ...
  scale_x_date(limits = (as.Date(c("1978-01-01", "2021-01-01"))), date_breaks = "5 years", date_labels = "%Y") +
  theme(legend.title = element_blank(), panel.background = element_blank(), axis.line = element_line("black"), axis.title = element_text(size = 12)) +
  labs(title = "(D) Scott Reef SCOTTSL1 (-14.08, 121.95)", y = ("Temperature°C"), x = "Time")
...
TS_Ningaloo_08BND <- Ningaloo_08BND_comb %>% 
  ...
  scale_x_date(limits = (as.Date(c("1978-01-01", "2021-01-01"))), date_breaks = "5 years", date_labels = "%Y") +
  theme(legend.title = element_blank(), panel.background = element_blank(), axis.line = element_line("black"), axis.title = element_text(size = 12)) +
  labs(title = "(E) Ningaloo Reef 08BND (-21.87, 114.16)", y = ("Temperature°C"), x = "Time")
...
TS_Ningaloo_13BND <- Ningaloo_13BND_comb %>% 
  ...
  scale_x_date(limits = (as.Date(c("1978-01-01", "2021-01-01"))), date_breaks = "5 years", date_labels = "%Y") +
  theme(legend.title = element_blank(), panel.background = element_blank(), axis.line = element_line("black"), axis.title = element_text(size = 12)) +
  labs(title = "(F) Ningaloo Reef 13BND (-21.87, 114.16)", y = ("Temperature°C"), x = "Time")
...
TS_Ningaloo_08TNT <- Ningaloo_08TNT_comb %>% 
  ...
  scale_x_date(limits = (as.Date(c("1978-01-01", "2021-01-01"))), date_breaks = "5 years", date_labels = "%Y") +
  theme(legend.title = element_blank(), panel.background = element_blank(), axis.line = element_line("black"), axis.title = element_text(size = 12)) +
  labs(title = "(G) Ningaloo Reef 08TNT (-21.91, 113.97)", y = ("Temperature°C"), x = "Time")
...
TS_Ningaloo_13TNT <- Ningaloo_13TNT_comb %>% 
  ...
  scale_x_date(limits = (as.Date(c("1978-01-01", "2021-01-01"))), date_breaks = "5 years", date_labels = "%Y") +
  theme(legend.title = element_blank(), panel.background = element_blank(), axis.line = element_line("black"), axis.title = element_text(size = 12)) +
  labs(title = "(H) Ningaloo Reef 13TNT (-21.91, 113.97)", y = ("Temperature°C"), x = "Time")
...
TS_HAbrol_HAB10A <- HAbrol_HAB10A_SrCa_comb %>% 
  ...
  scale_x_date(limits = (as.Date(c("1978-01-01", "2021-01-01"))), date_breaks = "5 years", date_labels = "%Y") +
  theme(legend.title = element_blank(), panel.background = element_blank(), axis.line = element_line("black"), axis.title = element_text(size = 12)) +
  labs(title = "(I) Houtman Abrolhos HAB10A (-28.46, 113.75)", y = ("Temperature°C"), x = "Time")
...
TS_HAbrol_HAB05B <- HAbrol_HAB05B_SrCa_comb %>% 
  ...
  scale_x_date(limits = (as.Date(c("1978-01-01", "2021-01-01"))), date_breaks = "5 years", date_labels = "%Y") +
  theme(legend.title = element_blank(), panel.background = element_blank(), axis.line = element_line("black"), axis.title = element_text(size = 12)) +
  labs(title = "(J) Houtman Abrolhos HAB05B (-28.46, 113.77)", y = ("Temperature°C"), x = "Time")
