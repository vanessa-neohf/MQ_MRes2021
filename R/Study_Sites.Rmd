...
Cocos <- ggmap(Cocos_getmap, fullpage = TRUE) +
  ...
  theme(plot.caption = element_text(hjust = 0.5, size = 9), legend.title = element_blank(), legend.key = element_rect(fill = "transparent"), panel.background = element_rect(fill = "transparent"), legend.position = "none", legend.text = element_blank(), plot.title = element_text(size = 22, hjust = 0.5), panel.border = element_rect(color = "black", fill = "transparent", linetype = "dashed"), axis.text = element_text(size = 3)) +
