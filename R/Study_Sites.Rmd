...
watercolor <- get_map(location = c(lon = 110, lat = -20), zoom = 4, source = 'stamen', maptype="watercolor")
...
SS_Map <- ggmap(watercolor, fullpage = TRUE) +
  ...
  theme(plot.caption = element_text(hjust = 0.5, size = 9), legend.title = element_blank(), legend.key = element_rect(fill = "transparent"), panel.background = element_rect(fill = "transparent"), legend.position = "bottom", legend.text = element_text(size = 7), plot.title = element_text(size = 22, hjust = 0.5), panel.border = element_rect(color = "black", fill = "transparent", size = 2)) +
...
Cocos <- ggmap(Cocos_getmap, fullpage = TRUE) +
  ...
  geom_label_repel(data = Study_Sites, aes(x = Longitude, y = Latitude, label = Site, size = 2))
...
HAbrol_getmap <- get_map(location = c(lon = 113.75, lat = -28.45), zoom = 14, source = 'stamen', maptype="watercolor")
...
insetmap_Cocos <- viewport (width = 0.75, height = 0.3, x = 0.5, y = 0.83)
insetmap_Ningaloo <- viewport(width = 0.7, height = 0.55, x = 0.16, y = 0.72)
insetmap_HAbrol <- viewport(width = 0.7, height = 0.5, x = 0.16, y = 0.18)
insetmap_Scott <- viewport(width = 0.7, height = 0.55, x = 0.84, y = 0.72)
insetmap_Browse <- viewport(width = 0.7, height = 0.5, x = 0.84, y = 0.18)


jpeg(filename = "Study Sites with Insets.jpeg", res = 300, width = 680, height = 400, units = "mm" ) 
