...
xtable2kable(CM_Combined_DHW) %>% 
  kbl(digits = 2, caption = "Degree Heating Week Confusion Matrix of CCI (left) and NOAA (right)")

xtable2kable(CM_Combined_DHM) %>% 
  kbl(digits = 2, caption = "Degree Heating Month Confusion Matrix of CCI (left) and NOAA (right)")
