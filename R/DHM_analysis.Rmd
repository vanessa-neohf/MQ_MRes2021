...
BRS07 <- BRS07_Combined %>% 
  ...
  labs(x = "", y = "", title = "(B) BRS07 (-14.12, 123.55)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
DARL <- DARL_Combined %>% 
  ...
  labs(x = "", y = "Degree Heating Month", title = "(A) DAR Long (-12.09, 96.88)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
SCOTT_RPO_1 <- SCOTT_RPO_1_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "SCOTT_RPO_1 (-14.06, 121.78)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
SCOTTSL1 <- SCOTTSL1_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "SCOTTSL1 (-14.08, 121.95)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
`08BND` <- Bundegi_08BND_Combined %>% 
  ...
  labs(x = "", y = "Degree Heating Month", title = "(C) 08BND (-21.87, 114.16)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
`13BND` <- Bundegi_13BND_Combined %>% 
  ...
  annotate("text", x = as.Date("2017-06-01"), y = Inf, label = "2016", hjust = 0, vjust = 1, size = 3)+
  geom_line(aes(x = monthly_date, y = Bundegi_DHM, color = Data_Type), alpha = 0.5, size = 1.3) +
  labs(x = "", y = "", title = "(D) 13BND (-21.87, 114.16)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
`08TNT` <- Tantabiddi_08TNT_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "(E) 08TNT (-21.91, 113.97)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
`13TNT` <- Tantabiddi_13TNT_Combined %>% 
  ...
  labs(x = "Date", y = "", title = "(F) 13TNT (-21.91, 113.97)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
HAB05B <- HAB05B_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "HAB05B (-28.46, 113.77)")+
  scale_fill_discrete_diverging(name = "Data Source")  +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
HAB10A <- HAB10A_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "HAB10A (-28.46, 113.75)")+
  scale_fill_discrete_diverging(name = "Data Source")  +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
