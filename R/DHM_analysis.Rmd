...
Date_Coral_Core <- rbind(Date_BRS05_CCI, Date_BRS05_NOAA, Date_BRS07_CCI, Date_BRS07_NOAA, Date_DARL_CCI, Date_DARL_NOAA)
...
Tantabiddi_13TNT_Combined <- rbind(CCI_Tantabiddi_13TNT, NOAA_Tantabiddi_13TNT)
...
Tantabiddi_08TNT_Combined <- rbind(CCI_Tantabiddi_08TNT, NOAA_Tantabiddi_08TNT)
...
```{r DHM_TNT, echo = FALSE, message = FALSE, include = FALSE}
...
kbl(High_TNT_DHM, longtable = T, caption = "Coral Core Date Range is from 1985 to 1994") %>% 
  kable_styling(position = "center", latex_options = c("repeat_header")) %>% 
  add_header_above(c(" " = 2, "Degree Heating Month Values in TNT" = 2), bold = TRUE) #%>% 
#  row_spec(color.me, color= "red")
...
```{r DHM_TNT07C, echo = FALSE, message = FALSE, include = FALSE}
...
```{r DHM_Wallabi_Island, echo = FALSE, message = FALSE, include = FALSE}
...
kbl(High_Wallabi_Island_DHM, longtable = T, caption = "Coral Core Date Range is from 1985 to 1994") %>% 
  kable_styling(position = "center", latex_options = c("repeat_header")) %>% 
  add_header_above(c(" " = 2, "Degree Heating Month Values in Wallabi Island" = 2), bold = TRUE) #%>% 
#  row_spec(color.me, color = "red")
...
```{r DHM_HAB05B, echo = FALSE, message = FALSE, include = FALSE}
...
```{r DHM_HAB10A, echo = FALSE, message = FALSE, include = FALSE}
