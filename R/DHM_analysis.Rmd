...
scan_gaps(ts_TNT_CCI_Core) 

ts_13TNT_CCI_Core <- as_tsibble(CCore_13TNT_CCI, index = yearmonth)
scan_gaps(ts_13TNT_CCI_Core) 

ts_08TNT_CCI_Core <- as_tsibble(CCore_08TNT_CCI, index = yearmonth)
scan_gaps(ts_08TNT_CCI_Core)

ts_Wallabi_Island_CCI_Core <- as_tsibble(CCore_Wallabi_Island_CCI, index = yearmonth)
scan_gaps(ts_Wallabi_Island_CCI_Core)
...
scan_gaps(ts_BRS05_NOAA_Core) #no gaps

ts_BRS07_NOAA_Core <- as_tsibble(CCore_BRS07_NOAA, index = yearmonth)
scan_gaps(ts_BRS07_NOAA_Core) #no gaps

ts_DARL_NOAA_Core <- as_tsibble(CCore_DARL_NOAA, index = yearmonth)
scan_gaps(ts_DARL_NOAA_Core) #no gaps

ts_TNT_NOAA_Core <- as_tsibble(CCore_TNT_NOAA, index = yearmonth)
scan_gaps(ts_13TNT_NOAA_Core) 

ts_13TNT_NOAA_Core <- as_tsibble(CCore_13TNT_NOAA, index = yearmonth)
scan_gaps(ts_13TNT_NOAA_Core) 

ts_08TNT_NOAA_Core <- as_tsibble(CCore_08TNT_NOAA, index = yearmonth)
scan_gaps(ts_08TNT_NOAA_Core)

ts_Wallabi_Island_NOAA_Core <- as_tsibble(CCore_Wallabi_Island_NOAA, index = yearmonth)
scan_gaps(ts_Wallabi_Island_NOAA_Core)
