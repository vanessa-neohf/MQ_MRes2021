...
```{r DHM_BUN05A, echo = FALSE, message = FALSE, include = FALSE}
...
#    geom_rect(aes_string(xmin = as.Date(c("2015-06-01")), xmax = as.Date(c("2017-06-01")),
#                ymin = -Inf, ymax = Inf), color = "blue", fill = "transparent", alpha = 0.5)+
#  geom_line(aes(x = monthly_date, y = BUN05A_DHM, color = Data_Type), alpha = 0.5, size = 1.3) +
...
Tantabiddi_08TNT_Combined %>% 
  ...
  geom_rect(aes_string(xmin = as.Date(c("2010-06-01")), xmax = as.Date(c("2012-06-01")),
    ...
    geom_rect(aes_string(xmin = as.Date(c("2015-06-01")), xmax = as.Date(c("2017-06-01")),
                ymin = -Inf, ymax = Inf), color = "blue", fill = "transparent", alpha = 0.5)+
  geom_line(aes(x = monthly_date, y = `08TNT_DHM`, color = Data_Type), alpha = 0.5, size = 1.3) +
...
#    geom_rect(aes_string(xmin = as.Date(c("2015-06-01")), xmax = as.Date(c("2017-06-01")),
#                ymin = -Inf, ymax = Inf), color = "blue", fill = "transparent", alpha = 0.5)+
#  geom_line(aes(x = monthly_date, y = TNT_DHM, color = Data_Type), alpha = 0.5, size = 1.3) +
...
#    geom_rect(aes_string(xmin = as.Date(c("2015-06-01")), xmax = as.Date(c("2017-06-01")),
#                ymin = -Inf, ymax = Inf), color = "blue", fill = "transparent", alpha = 0.5)+
#  geom_line(aes(x = monthly_date, y = TNT07C_DHM, color = Data_Type), alpha = 0.5, size = 1.3) +
...
#    geom_rect(aes_string(xmin = as.Date(c("2015-06-01")), xmax = as.Date(c("2017-06-01")),
#                ymin = -Inf, ymax = Inf), color = "blue", fill = "transparent", alpha = 0.5)+
#  geom_line(aes(x = monthly_date, y = Wallabi_Island_DHM, color = Data_Type), alpha = 0.5, size = 1.3) +
