...
#Coral Core SST data calibrated from CCI data (with mmm)
#maximum monthly mean (mmm) calculated from 1985-1990
#BRS05, BRS07, DAR Long sites - with SST data from 1985-1990
...
#Coral Core SST data calibrated from NOAA data (with mmm)
#maximum monthly mean (mmm) calculated from 1985-1990
#BRS05, BRS07, DAR Long sites - with SST data from 1985-1990
#exclude d18O coral proxy sites with monthly data - Wallabi Island, TNT
#exclude coral proxy data with annual SST - HAB10A, HAB05B, BUN05A, TNT07C
...
DAR3_Combined <- rbind(CCI_DAR3, NOAA_DAR3, CCore_DAR3_CCI, CCore_DAR3_NOAA)
...
Bundegi_13BND_Combined <- rbind(CCI_Bundegi, NOAA_Bundegi, CCore_13BND_CCI, CCore_13BND_NOAA)
...
Bundegi_08BND_Combined <- rbind(CCI_Bundegi, NOAA_Bundegi, CCore_08BND_CCI, CCore_08BND_NOAA)
...
SCOTT_RPO_1_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "SCOTT_RPO_1 Degree Heating Month values time plot")+
  scale_color_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 2, 4)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
SCOTT_SL4_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "SCOTT_SL4 Degree Heating Month values time plot")+
  scale_color_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 2, 4)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
SCOTT_SS3_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "SCOTT_SS3 Degree Heating Month values time plot")+
  scale_color_discrete_diverging(name = "Data Source")  +
  scale_y_continuous(breaks = c(0, 2, 4)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
SCOTTNR1_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "SCOTTNR1 Degree Heating Month values time plot")+
  scale_color_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 2, 4)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
SCOTTSL2_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "SCOTTSL2 Degree Heating Month values time plot")+
  scale_color_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 2, 4)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
SCOTTSL3_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "SCOTTSL3 Degree Heating Month values time plot")+
  scale_color_discrete_diverging(name = "Data Source")  +
  scale_y_continuous(breaks = c(0, 2, 4)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
SCOTTSS1_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "SCOTTSS1 Degree Heating Month values time plot")+
  scale_color_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 2, 4)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
SCOTTSS2_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "SCOTTSS2 Degree Heating Month values time plot")+
  scale_color_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 2, 4)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
Bundegi_13BND_Combined <- rbind(CCI_Bundegi_13BND, NOAA_Bundegi_13BND, CCore_13BND_CCI, CCore_13BND_NOAA)
...
#Combining datasets with DHM calculations
Bundegi_08BND_Combined <- rbind(CCI_Bundegi_08BND, NOAA_Bundegi_08BND, CCore_08BND_CCI, CCore_08BND_NOAA)
...
#Visualising DHM values in CCI, NOAA and CCore - 08BND
Bundegi_08BND_Combined %>% 
  ...
  geom_rect(aes_string(xmin = as.Date(c("2010-06-01")), xmax = as.Date(c("2012-06-01")),
    ...
    geom_rect(aes_string(xmin = as.Date(c("2015-06-01")), xmax = as.Date(c("2017-06-01")),
                ymin = -Inf, ymax = Inf), color = "blue", fill = "transparent", alpha = 0.5)+
  geom_line(aes(x = monthly_date, y = `08BND_DHM`, color = Data_Type), alpha = 0.5, size = 1.3) +
...
#Visualising DHM values in CCI, NOAA and CCore - 13BND
Bundegi_13BND_Combined %>% 
  ...
  geom_rect(aes_string(xmin = as.Date(c("2010-06-01")), xmax = as.Date(c("2012-06-01")),
    ...
    geom_rect(aes_string(xmin = as.Date(c("2015-06-01")), xmax = as.Date(c("2017-06-01")),
                ymin = -Inf, ymax = Inf), color = "blue", fill = "transparent", alpha = 0.5)+
  geom_line(aes(x = monthly_date, y = `13BND_DHM`, color = Data_Type), alpha = 0.5, size = 1.3) +
