...
write_csv(CCI_BUN05A, here::here("data_raw/DHM/CCI_BUN05A_DHM.csv"))
...
write_csv(NOAA_BUN05A, here::here("data_raw/DHM/NOAA_BUN05A_DHM.csv"))
...
write_csv(CCI_Bundegi, here::here("data_raw/DHM/CCI_Bundegi_DHM.csv"))
...
write_csv(NOAA_Bundegi, here::here("data_raw/DHM/NOAA_Bundegi_DHM.csv"))
...
kbl(High_13TNT_DHM, longtable = T, caption = "Coral Core Date Range is from 2004 to 2013") %>% 
  kable_styling(position = "center", latex_options = c("repeat_header")) %>% 
  add_header_above(c(" " = 2, "Degree Heating Month Values in 13TNT" = 3), bold = TRUE) %>% 
  row_spec(color.me, color = "red")
...
write_csv(CCI_TNT, here::here("data_raw/DHM/CCI_TNT_DHM.csv"))
...
write_csv(NOAA_TNT, here::here("data_raw/DHM/NOAA_TNT_DHM.csv"))
...
CCore_TNT_CCI <- CCore_TNT_CCI %>% 
  add_column(TNT_DHM) %>% 
  mutate(TNT_DHM = if_else(is.na(sst_monthly), NA_real_ , TNT_DHM))

write_csv(CCore_TNT_CCI, here::here("data_raw/DHM/CCore_TNT_CCI_DHM.csv"))
...
write_csv(CCore_TNT_NOAA, here::here("data_raw/DHM/CCore_TNT_NOAA_DHM.csv"))
...
color.me <- which(High_TNT_DHM$`Coral Core (CCI)`> 0 | High_TNT_DHM$`Coral Core (NOAA)` >0)

kbl(High_TNT_DHM, longtable = T, caption = "Coral Core Date Range is from 1985 to 1994") %>% 
  kable_styling(position = "center", latex_options = c("repeat_header")) %>% 
  add_header_above(c(" " = 2, "Degree Heating Month Values in TNT" = 4), bold = TRUE) %>% 
  row_spec(color.me, color= "red")
...
write_csv(CCI_TNT07C, here::here("data_raw/DHM/CCI_TNT07C_DHM.csv"))
...
write_csv(NOAA_TNT07C, here::here("data_raw/DHM/NOAA_TNT07C_DHM.csv"))
...
write_csv(CCI_Wallabi_Island, here::here("data_raw/DHM/CCI_Wallabi_Island_DHM.csv"))
...
write_csv(NOAA_Wallabi_Island, here::here("data_raw/DHM/NOAA_Wallabi_Island_DHM.csv"))
...
CCore_Wallabi_Island_CCI <- CCore_Wallabi_Island_CCI %>% 
  add_column(Wallabi_Island_DHM) %>% 
  mutate(Wallabi_Island_DHM = if_else(is.na(sst_monthly), NA_real_ , Wallabi_Island_DHM))

write_csv(CCore_Wallabi_Island_CCI, here::here("data_raw/DHM/CCore_Wallabi_Island_CCI_DHM.csv"))
...
write_csv(CCore_Wallabi_Island_NOAA, here::here("data_raw/DHM/CCore_Wallabi_Island_NOAA_DHM.csv"))
...
color.me <- which(High_Wallabi_Island_DHM$`Coral Core (CCI)`> 0 | High_Wallabi_Island_DHM$`Coral Core (NOAA)` >0)

kbl(High_Wallabi_Island_DHM, longtable = T, caption = "Coral Core Date Range is from 1985 to 1994") %>% 
  kable_styling(position = "center", latex_options = c("repeat_header")) %>% 
  add_header_above(c(" " = 2, "Degree Heating Month Values in Wallabi Island" = 4), bold = TRUE) %>% 
  row_spec(color.me, color = "red")
