...
BRS07 <- BRS07_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "BRS07 (-14.12, 123.55)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
DARL <- DARL_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "DAR Long (-12.09, 96.88)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
`08BND` <- Bundegi_08BND_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "08BND (-21.87, 114.16)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
`08TNT` <- Tantabiddi_08TNT_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "08TNT (-21.91, 113.97)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
`13TNT` <- Tantabiddi_13TNT_Combined %>% 
  ...
  labs(x = "Date", y = "Degree Heating Month", title = "13TNT (-21.91, 113.97)")+
  scale_fill_discrete_diverging(name = "Data Source") +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
