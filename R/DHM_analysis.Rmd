...
ggplot(BRS05_cum_HSdays) +
  ...
  labs(x = "Time", y = "Cumulative high DHM days", title = "BRS05", color = "Data Type") +
...
#Cumulative Plot
BRS07_cum_HSdays <- BRS07_Combined %>% 
...
ggplot(BRS07_cum_HSdays) +
  geom_line(aes(x = monthly_date, y = DHM_months_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative high DHM days", title = "BRS07", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
...
BRS07 <- BRS07_Combined %>% 
  ...
  labs(x = "", y = "", title = "(B) BRS07 (-14.12, 123.55)", subtitle = "Browse Island")+
  scale_color_manual(values = cols) +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(DARL_cum_HSdays) +
  geom_line(aes(x = monthly_date, y = DHM_months_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative high DHM days", title = "DARL", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
...
ggplot(SCOTT_RPO_1_cum_HSdays) +
  geom_line(aes(x = monthly_date, y = DHM_months_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative high DHM days", title = "SCOTT_RPO_1", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
...
ggsave("Supp_SCOTT_RPO_1_DHM.png", path = here::here("graphics/Figures"), dpi = 300, scale = 1, limitsize = FALSE)
...
ggplot(SCOTTSL1_cum_HSdays) +
  geom_line(aes(x = monthly_date, y = DHM_months_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative high DHM days", title = "SCOTTSL1", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
...
SCOTTSL1 <- SCOTTSL1_Combined %>% 
  ...
  scale_x_date(limits = as_date(c("1985-01-01","2030-01-01")))+
  labs(x = "Date", y = "Degree Heating Month", title = "(B) SCOTTSL1 (-14.08, 121.95)", subtitle = "Scott Reef")+
  scale_color_manual(values = cols_no_cc) +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggsave("Supp_SCOTT_SL1_DHM.png", path = here::here("graphics/Figures"), dpi = 300, scale = 1, limitsize = FALSE)
...
#Cumulative Plot
Bundegi_13BND_cum_HSdays <- Bundegi_13BND_Combined %>% 
...
ggplot(Bundegi_13BND_cum_HSdays) +
  geom_line(aes(x = monthly_date, y = DHM_months_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative high DHM days", title = "Bundegi 13BND", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
...
#Cumulative Plot
Bundegi_08BND_cum_HSdays <- Bundegi_08BND_Combined %>% 
  select(monthly_date, Reef_Site, Data_Type, Bundegi_DHM) %>% 
  mutate(Bundegi_DHM = if_else(Bundegi_DHM > 1, 1, 0)) %>% 
  group_by(Data_Type) %>% 
  mutate(DHM_months_count = cumsum(Bundegi_DHM)) %>% 
...
ggplot(Bundegi_08BND_cum_HSdays) +
  geom_line(aes(x = monthly_date, y = DHM_months_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative high DHM days", title = "Bundegi 08BND", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
...
`08BND` <- Bundegi_08BND_Combined %>% 
  ...
  scale_x_date(limits = as_date(c("1985-01-01","2030-01-01")))+
  labs(x = "", y = "Degree Heating Month", title = "(C) 08BND (-21.87, 114.16)", subtitle = "Ningaloo Reef")+
  scale_color_manual(values = cols) +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
`13BND` <- Bundegi_13BND_Combined %>% 
  ...
  geom_line(aes(x = monthly_date, y = Bundegi_DHM, color = Data_Type), alpha = 0.5, size = 1.3) +
  scale_x_date(limits = as_date(c("1985-01-01","2030-01-01")))+
  labs(x = "", y = "", title = "(D) 13BND (-21.87, 114.16)", subtitle = "Ningaloo Reef")+
  scale_color_manual(values = cols) +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
#Cumulative Plot
Tantabiddi_08TNT_cum_HSdays <- Tantabiddi_08TNT_Combined %>% 
...
ggplot(Tantabiddi_08TNT_cum_HSdays) +
  geom_line(aes(x = monthly_date, y = DHM_months_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative high DHM days", title = "Tantabiddi 08TNT", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01"))) 
...
#Cumulative Plot
Tantabiddi_13TNT_cum_HSdays <- Tantabiddi_13TNT_Combined %>% 
  select(monthly_date, Reef_Site, Data_Type, Tantabiddi_DHM) %>% 
  mutate(Tantabiddi_DHM = if_else(Tantabiddi_DHM > 1, 1, 0)) %>% 
  group_by(Data_Type) %>% 
  mutate(DHM_months_count = cumsum(Tantabiddi_DHM)) %>% 
...
ggplot(Tantabiddi_13TNT_cum_HSdays) +
  geom_line(aes(x = monthly_date, y = DHM_months_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative high DHM days", title = "Tantabiddi 13TNT", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01"))) 
...
ggplot(HAB05B_cum_HSdays) +
  geom_line(aes(x = monthly_date, y = DHM_months_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative high DHM days", title = "HAB05B", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
...
HAB05B <- HAB05B_Combined %>% 
  ...
  scale_x_date(limits = as_date(c("1985-01-01","2030-01-01")))+
  labs(x = "Date", y = "Degree Heating Month", title = "(D) HAB05B (-28.46, 113.77)", subtitle = "Houtman Abrolhos")+
  scale_color_manual(values = cols_no_cc) +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggsave("Supp_HAB05B_DHM.png", path = here::here("graphics/Figures"), dpi = 300, scale = 1, limitsize = FALSE)
...
ggplot(HAB10A_cum_HSdays) +
  geom_line(aes(x = monthly_date, y = DHM_months_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative high DHM days", title = "HAB10A", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
...
HAB10A <- HAB10A_Combined %>% 
  ...
  scale_x_date(limits = as_date(c("1985-01-01","2030-01-01")))+
  labs(x = "Date", y = "Degree Heating Month", title = "(C) HAB10A (-28.46, 113.75)", subtitle = "Houtman Abrolhos")+
  scale_color_manual(values = cols_no_cc) +
  scale_y_continuous(breaks = c(0, 1, 2)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggsave("Supp_HAB10A_DHM.png", path = here::here("graphics/Figures"), dpi = 300, scale = 1, limitsize = FALSE)
