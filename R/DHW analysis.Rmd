...
NOAA_TNT <- read_csv(here::here("data_raw", "CCI_TNT_with_mmm_and_dhw.csv"))
...
```{r DHW Time Series Plots, echo = FALSE}
#BRS05
CCI_BRS05 <- CCI_BRS05 %>% 
...
ggplot(BRS05_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of BRS05 Degree Heating Week values") +
...
ggplot(BRS07_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of BRS07 Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(DAR3_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of DAR3 Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(DARL_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of DAR Long Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(SCOTT_RPO_1_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of SCOTT_RPO_1 Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(SCOTT_SL4_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of SCOTT_SL4 Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(SCOTT_SS3_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of SCOTT_SS3 Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(SCOTTNR1_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of SCOTTNR1 Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(SCOTTSL1_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of SCOTTSL1 Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(SCOTTSL2_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of SCOTTSL2 Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(SCOTTSL3_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of SCOTTSL3 Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(SCOTTSS1_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of SCOTTSS1 Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(SCOTTSS2_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of SCOTTSS2 Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(BUN05A_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of BUN05A Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(Bundegi_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of 08BND and 13BND Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(Tantabiddi_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of 08TNT and 13TNT Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(TNT_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of TNT Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(TNT07C_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of TNT07C Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(Wallabi_Island_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of Wallabi Island Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(HAB05B_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of HAB05B Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
ggplot(HAB10A_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type)) +
  labs(x = "Time", y = "DHW value", title = "Time Series of HAB10A Degree Heating Week values") +
  scale_color_discrete_qualitative(name = "Satellite") +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20)) +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
