...
## Comparison of SST time series in Browse Island sites
...
## Comparison of SST time series in Cocos (Keeling) Island sites
- DAR3 (-12.095, 96.8805)
...
## Comparison of SST time series in Ningaloo Reef sites
...
## Comparison of SST time series in Houtman Abrolhos Island sites
...
modelsummary::modelsummary(list(lm2))
```
...
# Too many missing gaps in Logger Data
