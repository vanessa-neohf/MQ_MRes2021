...
Browse_05_Logger <- read_csv(here::here("data_raw", "Logger_Avg_Daily_SST_SCOTTSS1.csv")) %>% 
  ...
  mutate(data_type = "Logger", year = year(time), month = month(time)) %>% #prepare data for binding with other data types
  na.omit(sst) %>% 
  group_by(year, month) %>% 
  mutate(sst = mean(sst)) %>% 
  ungroup %>% 
...
ggplot(BRS05_joint, aes(x = browse_coral_core, y = browse_NOAA)) + 
  ...
  labs(title = "BRS05 Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST")
...
ggplot(BRS05_joint, aes(x = browse_coral_core, y = browse_CCI)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "BRS05 Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "CCI SST")
...
ggplot(BRS07_joint, aes(x = browse_coral_core, y = browse_NOAA)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "BRS07 Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST")
# linear decreasing trend with a slight curvature. 
# gam1 <- gam(browse_NOAA ~ s(browse_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam1)
# summary(gam1)
...
ggplot(BRS07_joint, aes(x = browse_coral_core, y = browse_CCI)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "BRS07 Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "CCI SST")
# linear decreasing trend with a slight curvature. 
# gam2 <- gam(browse_CCI ~ s(browse_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam2)
# summary(gam2)
...
ggplot(DARL_joint, aes(x = Cocos_coral_core, y = Cocos_NOAA)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "DAR Long Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST")
...
ggplot(DARL_joint, aes(x = Cocos_coral_core, y = Cocos_CCI)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "DAR Long Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "CCI SST")
# linear decreasing trend 
...
ggplot(DAR3_joint, aes(x = Cocos_coral_core, y = Cocos_NOAA)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "DAR3 Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST")
# linear decreasing trend with a slight curvature. 
# gam1 <- gam(Cocos_NOAA ~ s(Cocos_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam1)
# summary(gam1)
...
ggplot(DAR3_joint, aes(x = Cocos_coral_core, y = Cocos_CCI)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "DAR3 Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "CCI SST")
# linear decreasing trend with a slight curvature. 
# gam2 <- gam(Cocos_CCI ~ s(Cocos_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam2)
# summary(gam2)
...
ggplot(Tantabiddi_13TNT_joint, aes(x = ningaloo_coral_core, y = ningaloo_NOAA)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "13TNT Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST")
# linear decreasing trend with a slight curvature. 
...
ggplot(Tantabiddi_13TNT_joint, aes(x = ningaloo_coral_core, y = ningaloo_CCI)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "13TNT Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "CCI SST")
# linear decreasing trend with a slight curvature. 
...
ggplot(Tantabiddi_08TNT_joint, aes(x = ningaloo_coral_core, y = ningaloo_NOAA)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "08TNT Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST")
# linear decreasing trend 
# gam1 <- gam(ningaloo_NOAA ~ s(ningaloo_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam1)
# summary(gam1)
...
ggplot(Tantabiddi_08TNT_joint, aes(x = ningaloo_coral_core, y = ningaloo_CCI)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "08TNT Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "CCI SST")
# linear decreasing trend 
# gam2 <- gam(ningaloo_CCI ~ s(ningaloo_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam2)
# summary(gam2)
...
ggplot(Bundegi_08BND_joint, aes(x = ningaloo_coral_core, y = ningaloo_NOAA)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "08BND Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST")
...
ggplot(Bundegi_08BND_joint, aes(x = ningaloo_coral_core, y = ningaloo_CCI)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "08BND Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "CCI SST")
# linear decreasing trend with curvature. 
# gam2 <- gam(ningaloo_CCI ~ s(ningaloo_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam2)
# summary(gam2)
...
ggplot(TNT07C_joint, aes(x = ningaloo_coral_core, y = ningaloo_NOAA)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "TNT07C Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST")
# linear decreasing trend 
# gam1 <- gam(ningaloo_NOAA ~ s(ningaloo_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam1)
# summary(gam1)
...
ggplot(TNT07C_joint, aes(x = ningaloo_coral_core, y = ningaloo_CCI)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "TNT07C Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "CCI SST")
# linear decreasing trend 
# gam2 <- gam(ningaloo_CCI ~ s(ningaloo_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam2)
# summary(gam2)
...
ggplot(BUN05A_joint, aes(x = ningaloo_coral_core, y = ningaloo_NOAA)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "BUN05A Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST")
# linear decreasing trend 
# gam1 <- gam(ningaloo_NOAA ~ s(ningaloo_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam1)
# summary(gam1)
...
ggplot(BUN05A_joint, aes(x = ningaloo_coral_core, y = ningaloo_CCI)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "BUN05A Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "CCI SST")
# linear decreasing trend 
# gam2 <- gam(ningaloo_CCI ~ s(ningaloo_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam2)
# summary(gam2)
...
ggplot(HAB05B_SrCa_joint, aes(x = HAbrol_coral_core, y = HAbrol_CCI)) + 
  geom_point() + 
  geom_smooth(method = "gam") %>% 
  labs(title = "HAB05B Coral Core Calibration", x = "Coral Core Sr/Ca Ratio", y = "CCI SST")
# linear decreasing trend
# gam2 <- gam(HAbrol_CCI ~ s(HAbrol_coral_core, bs = "cs"), data = dat_joint, method = "REML")
# plot(gam2)
# summary(gam2)
...
Browse_Plot_NOAA <- Browse %>% 
  ...
  geom_point() +
  geom_smooth() +
  labs(title = "Browse Island NOAA SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST") +
  facet_wrap("Site")
...
Browse_Plot_CCI <- Browse %>% 
  ...
  geom_point() +
  geom_smooth() +
  labs(title = "Browse Island CCI SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "CCI SST") +
  facet_wrap("Site")
...
C_Browse_Plot_NOAA <- Browse %>% 
  ...
  geom_smooth() +
  labs(title = "Browse Island NOAA SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST", caption = "[Range of R Square values is from 0.497 to 0.570]")

C_Browse_Plot_CCI <- Browse %>% 
  ggplot(aes(x = browse_coral_core, y = browse_CCI, color = Site)) +
  geom_smooth() +
  labs(title = "Browse Island CCI SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "CCI SST", caption = "[Range of R Square values is from 0.568 to 0.622]")
...
Cocos_Keeling_Plot_NOAA <- Cocos_Keeling %>% 
  ...
  geom_point() +
  geom_smooth() +
  labs(title = "Cocos Keeling Island NOAA SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST") +
  facet_wrap("Site")
...
Cocos_Keeling_Plot_CCI <- Cocos_Keeling %>% 
  ...
  geom_point() +
  geom_smooth() +
  labs(title = "Cocos Keeling Island CCI SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "CCI SST") +
  facet_wrap("Site")
...
C_Cocos_Plot_NOAA <- Cocos_Keeling %>% 
  ...
  geom_smooth() +
  labs(title = "Cocos Keeling Island NOAA SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST", caption = "[R Square values for both sites are 0.188]")

C_Cocos_Plot_CCI <- Cocos_Keeling %>% 
  ggplot(aes(x = Cocos_coral_core, y = Cocos_CCI, color = Site)) +
  geom_smooth() +
  labs(title = "Cocos Keeling Island CCI SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "CCI SST", caption = "[R Square values for both sites are 0.244]")
...
Ningaloo_Plot_NOAA <- Ningaloo %>% 
  ...
  geom_point() +
  geom_smooth() +
  labs(title = "Ningaloo Reef NOAA SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST") +
  facet_wrap("Site")
...
Ningaloo_Plot_CCI <- Ningaloo %>% 
  ...
  geom_point() +
  geom_smooth() +
  labs(title = "Ningaloo Reef CCI SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "CCI SST") +
  facet_wrap("Site")
...
C_Ningaloo_Plot_NOAA <- Ningaloo %>% 
  ...
  geom_smooth() +
  labs(title = "Ningaloo Reef NOAA SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST", caption = "[Range of R Square values is from 0.631 to 0.839]")

C_Ningaloo_Plot_CCI <- Ningaloo %>% 
  ggplot(aes(x = ningaloo_coral_core, y = ningaloo_CCI, color = Site)) +
  geom_smooth() +
  labs(title = "Ningaloo Reef CCI SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "CCI SST", caption = "[Range of R Square values is from 0.320 to 0.668]")
...
HAbrol_Plot_NOAA <- HAbrol %>% 
  ...
  geom_point() +
  geom_smooth() +
  labs(title = "Houtman Abrolhos NOAA SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST") +
  facet_wrap("Site")
...
HAbrol_Plot_CCI <- HAbrol %>% 
  ...
  geom_point() +
  geom_smooth() +
  labs(title = "Houtman Abrolhos CCI SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "CCI SST") +
  facet_wrap("Site")
...
C_HAbrol_Plot_NOAA <- HAbrol %>% 
  ...
  geom_smooth() +
  labs(title = "Houtman Abrolhos NOAA SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST", caption = "[Range of R Square values is from 0.155 to 0.282]")

C_HAbrol_Plot_CCI <- HAbrol %>% 
  ggplot(aes(x = HAbrol_coral_core, y = HAbrol_CCI, color = Site)) +
  geom_smooth() +
  labs(title = "Houtman Abrolhos CCI SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "CCI SST", caption = "[Range of R Square values is from 0.142 to 0.336]") 
...
Wallabi_Plot_NOAA <- Wallabi_Island_joint %>% 
  ggplot(aes(x = HAbrol_coral_core, y = HAbrol_NOAA, color = Site)) +
  geom_smooth() +
  labs(title = "Wallabi Island NOAA SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "NOAA SST", caption = "R Square value is 0.282")

Wallabi_Plot_CCI <- Wallabi_Island_joint %>% 
  ggplot(aes(x = HAbrol_coral_core, y = HAbrol_CCI, color = Site)) +
  geom_smooth() +
  labs(title = "Wallabi Island CCI SST and Sr/Ca Proxy", x = "Coral Core Sr/Ca Ratio", y = "CCI SST", caption = "R Square value is 0.336")
...
BRS05 <- ggplot(temp) + 
  ...
  xlim(0, 3.5) +
  ylim(0, 15) +
  ggtitle("(C) BRS05 (-14.11, 123.54)", subtitle = "Browse Island") +
...
BRS07 <- ggplot(temp) + 
  ...
  xlim(0, 3.5) +
  ylim(0, 15) +
  ggtitle("(D) BRS07 (-14.12, 123.55)", subtitle = "Browse Island") +
  theme(legend.position = "none",
        legend.direction = "horizontal",
        legend.title = element_blank())
...
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 11, main = "CCI and CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 11, main = "NOAA and CCORE")
wc.avg(wave_out_GCM_CCORE, maximum.level = 11, main = "GCM and CCORE")
...
DAR3 <- ggplot(temp) + 
  ...
  xlim(0, 3.5) +
  ylim(0, 15) +
  ggtitle("(B) DAR3 (-12.10, 96.88)", subtitle = "Cocos Keeling Island") +
  theme(legend.position = "none",
        legend.direction = "horizontal",
        legend.title = element_blank())
...
DARL <- ggplot(temp) + 
  ...
  xlim(0, 3.5) +
  ylim(0, 15) +
  ggtitle("(A) DAR Long (-12.09, 96.88)", subtitle = "Cocos Keeling Island") +
  theme(legend.position = "none",
        legend.direction = "horizontal",
        legend.title = element_blank())
...
`13TNT` <- ggplot(temp) + 
  ...
  xlim(0, 3.5) +
  ylim(0, 15) +
  ggtitle("(H) 13TNT (-21.91, 113.97)", subtitle = "Ningaloo Reef") +
  theme(legend.position = "none",
        legend.direction = "horizontal",
        legend.title = element_blank())
...
`08TNT` <- ggplot(temp) + 
  ...
  xlim(0, 3.5) +
  ylim(0, 15) +
  ggtitle("(G) 08TNT (-21.91, 113.97)", subtitle = "Ningaloo Reef") +
  theme(legend.position = "none",
        legend.direction = "horizontal",
        legend.title = element_blank())
...
`13BND` <- ggplot(temp) + 
  ...
  xlim(0, 3.5) +
  ylim(0, 15) +
  ggtitle("(F) 13BND (-21.87, 114.16)", subtitle = "Ningaloo Reef") +
  theme(legend.position = "none",
        legend.direction = "horizontal",
        legend.title = element_blank())
...
`08BND` <- ggplot(temp) + 
  ...
  xlim(0, 3.5) +
  ylim(0, 15) +
  ggtitle("(E) 08BND (-21.87, 114.16)", subtitle = "Ningaloo Reef") +
  theme(legend.position = "none",
        legend.direction = "horizontal",
        legend.title = element_blank())
...
TNT07C <- ggplot(temp) + 
  ...
  xlim(0, 0.75) +
  ylim(0, 6.5) +
  ggtitle("(B) TNT07C (-21.89, 113.96)", subtitle = "Ningaloo Reef") +
  theme(legend.position = "none",
        legend.direction = "horizontal",
        legend.title = element_blank())
...
BUN05A <- ggplot(temp) + 
  ...
  xlim(0, 0.75) +
  ylim(0, 6.5) +
  ggtitle("(A) BUN05A (-21.84, 114.18)", subtitle = "Ningaloo Reef") +
  theme(legend.position = "none",
        legend.direction = "horizontal",
        legend.title = element_blank())
...
HAB05B <- ggplot(temp) + 
  ...
  xlim(0, 0.75) +
  ylim(0, 6.5) +
  ggtitle("(C) HAB05B (-28.46, 113.77)", subtitle = "Ningaloo Reef") +
  theme(legend.position = "none",
        legend.direction = "horizontal",
        legend.title = element_blank())
...
\newpage
```{r Combined_Plots_Monthly, fig.width= 15, fig.height = 10}
