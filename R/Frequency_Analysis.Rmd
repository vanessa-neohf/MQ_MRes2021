...
C_Ningaloo_Plot_NOAA <- Ningaloo %>% 
  ...
  geom_smooth() +
  labs(title = "Ningaloo Reef NOAA SST and Coral Core Proxy", x = "Coral Core", y = "NOAA", caption = "[Range of R Square values is from 0.631 to 0.839]")

C_Ningaloo_Plot_CCI <- Ningaloo %>% 
  ggplot(aes(x = ningaloo_coral_core, y = ningaloo_CCI, color = Site)) +
  geom_smooth() +
  labs(title = "Ningaloo Reef CCI SST and Coral Core Proxy", x = "Coral Core", y = "CCI", caption = "[Range of R Square values is from 0.320 to 0.668]")
