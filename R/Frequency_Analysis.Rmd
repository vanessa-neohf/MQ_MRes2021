...
##Frequency Analysis - Spectral Analysis of Time Series
```{r Frequency_Analysis, echo = FALSE}
library(dplR)
...
plot(wave.avg_BRS05_CCore$period, wave.avg$power, type = "l")

#combined BRS05 plot
wave.avg_BRS05_Combined <- as_tibble(rbind(wave.avg_BRS05_CCI, wave.avg_BRS05_CCore, wave.avg_BRS05_NOAA))

ggplot(wave.avg_BRS05_Combined) +
