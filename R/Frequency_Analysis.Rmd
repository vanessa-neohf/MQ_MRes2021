...
Ningaloo <- rbind(Tantabiddi_13TNT_joint, Tantabiddi_08TNT_joint, Bundegi_13BND_joint, Bundegi_08BND_joint)
...
\newpage
**BRS05**
```{r Frequency_Analysis_Browse_BRS05, echo = FALSE, message = FALSE}

library(WaveletComp)

#Browse Island BRS05 site
#use _joint file with combined SST/Proxy values from NOAA, CCI and CCore
# CCI vs CCore and NOAA vs CCore for bivariate analysis
...
# BRS05 CCI
wave_out <- analyze.wavelet(BRS05_joint_smooth, "browse_CCI",
                            dt = 1/12,
                            dj = 1/10)
...
wave_out_CCI_CCORE <- 
  analyze.coherency(BRS05_joint_smooth, 
                    ...
                    loess.span = 0,
                    dt = 1/12, dj = 1/10)
wc.avg(wave_out_CCI_CCORE, main = "CCI vs CCORE")

#Covariance
wc.image(wave_out_CCI_CCORE, show.date = TRUE, 
         plot.arrow = FALSE, main = "CCI vs CCORE")
#Individual Series
...
wave_out_NOAA_CCORE <- 
  analyze.coherency(BRS05_joint_smooth, 
                    ...
                    loess.span = 0, 
                    dt = 1/12, dj = 1/10)
wc.avg(wave_out_NOAA_CCORE, main = "NOAA vs CCORE")

#Covariance
wc.image(wave_out_NOAA_CCORE, show.date = TRUE, 
         plot.arrow = FALSE, main = "NOAA vs CCORE")
#Individual Series
...
wc.image(wave_out_NOAA_CCORE, which.image = "wc", 
         show.date = TRUE, plot.arrow = FALSE, main = "NOAA vs CCORE")
#add-on to correlation
wc.avg(wave_out_NOAA_CCORE, which.avg = "wc",
       legend.coords = "topleft",
       main = "NOAA vs Coral Core")
wc.image(wave_out_NOAA_CCORE, which.image = "wc", 
         show.date = TRUE, plot.arrow = FALSE, main = "NOAA vs CCORE")
...
# CCI vs CCORE has a slightly higher power around period 1 than NOAA vs CCORE.
# NOAA vs CCORE has higher power around period 2 and 0.5. 
par(mfrow=c(2,1))
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 8.5, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 8.5, main = "NOAA vs CCORE")
...
wc.image(wave_out_NOAA_CCORE, which.image = "wc", show.date = TRUE, 
         plot.arrow = FALSE, main = "NOAA vs CCORE")
# CCI vs CCORE also appears to have a slightly higher correlation around period 1. 

## Ploting the two sets of average power together
...
\newpage
**BRS07**
```{r Frequency_Analysis_Browse_BRS07, echo = FALSE, message = FALSE}
...
wave_out <- analyze.wavelet(BRS07_joint_smooth, "browse_CCI",
                            dt = 1/12,
                            dj = 1/10)
wt.image(wave_out, n.levels = 250,
         legend.params = list(lab = "wavelet power levels"),
...
# cross-wavelet power (with certain limitations) to an assessment of the similarity of the two series’ wavelet power in the time-frequency (or time-scale) domain.
# CCI vs CCORE has a slightly higher power around period 1 than NOAA vs CCORE.
# NOAA vs CCORE has similar power to CCI vs CCORE around period 0.5, 2 and 4
par(mfrow=c(2,1))
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 9, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 9, main = "NOAA vs CCORE")
...
\newpage
**DAR3**
```{r Frequency_Analysis_Cocos_DAR3, echo = FALSE, message = FALSE}
...
wave_out <- analyze.wavelet(DAR3_joint_smooth, "Cocos_CCI",
                            dt = 1/12,
                            dj = 1/10)
wt.image(wave_out, n.levels = 250,
         legend.params = list(lab = "wavelet power levels"),
...
# cross-wavelet power (with certain limitations) to an assessment of the similarity of the two series’ wavelet power in the time-frequency (or time-scale) domain.
# CCI vs CCORE has a slightly higher power around period 1 than NOAA vs CCORE.
# NOAA vs CCORE has similar power to CCI vs CCORE around period 2 to 4
par(mfrow=c(2,1))
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 10, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 10, main = "NOAA vs CCORE")
...
\newpage
**DAR Long**
```{r Frequency_Analysis_Cocos_DARL, echo = FALSE, message = FALSE}
...
wave_out <- analyze.wavelet(DARL_joint_smooth, "Cocos_CCI",
                            dt = 1/12,
                            dj = 1/10)
wt.image(wave_out, n.levels = 250,
         legend.params = list(lab = "wavelet power levels"),
...
# cross-wavelet power (with certain limitations) to an assessment of the similarity of the two series’ wavelet power in the time-frequency (or time-scale) domain.
# CCI vs CCORE has a slightly higher power than NOAA vs CCORE around period 1.
# NOAA vs CCORE has slightly higher power than CCI vs CCORE around period 0.5
par(mfrow=c(2,1))
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 10, main = "CCI vs CCORE")
...
wc.image(wave_out_NOAA_CCORE, which.image = "wc", show.date = TRUE, 
         plot.arrow = FALSE, main = "NOAA vs CCORE")
# CCI vs CCORE also appears to have a similar correlation to NOAA vs CCORE around period 1. 

```

\newpage
**Tantabiddi 13TNT**
```{r Frequency_Analysis_Ningaloo_13TNT, echo = FALSE, message = FALSE}
...
wave_out <- analyze.wavelet(Tantabiddi_13TNT_joint_smooth, "ningaloo_CCI",
                            dt = 1/12,
                            dj = 1/10)
wt.image(wave_out, n.levels = 250,
         legend.params = list(lab = "wavelet power levels"),
...
# cross-wavelet power (with certain limitations) to an assessment of the similarity of the two series’ wavelet power in the time-frequency (or time-scale) domain.
# NOAA vs CCORE has a slightly higher power than CCI vs CCORE around period 1.

par(mfrow=c(2,1))
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 13, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 13, main = "NOAA vs CCORE")
...
wc.image(wave_out_NOAA_CCORE, which.image = "wc", show.date = TRUE, 
         plot.arrow = FALSE, main = "NOAA vs CCORE")
# CCI vs CCORE also appears to have a similar correlation to NOAA vs CCORE around period 0.5 and 1. 

```

\newpage
**Tantabiddi 08TNT**
```{r Frequency_Analysis_Ningaloo_08TNT, echo = FALSE, message = FALSE}
...
wave_out <- analyze.wavelet(Tantabiddi_08TNT_joint_smooth, "ningaloo_CCI",
                            dt = 1/12,
                            dj = 1/10)
wt.image(wave_out, n.levels = 250,
         legend.params = list(lab = "wavelet power levels"),
...
wc.image(wave_out_NOAA_CCORE, which.image = "wc", show.date = TRUE, 
         plot.arrow = FALSE, main = "NOAA vs CCORE")
# CCI vs CCORE also appears to have a similar correlation to NOAA vs CCORE around period 1 and 2. 

```

\newpage
**Bundegi 13BND**
```{r Frequency_Analysis_Ningaloo_13BND, echo = FALSE, message = FALSE}
...
wave_out <- analyze.wavelet(Bundegi_13BND_joint_smooth, "ningaloo_CCI",
                            dt = 1/12,
                            dj = 1/10)
wt.image(wave_out, n.levels = 250,
         legend.params = list(lab = "wavelet power levels"),
...
# cross-wavelet power (with certain limitations) to an assessment of the similarity of the two series’ wavelet power in the time-frequency (or time-scale) domain.
# CCI vs CCORE has a much higher power than NOAA vs CCORE around the peak (not at period 1 somehow).

par(mfrow=c(2,1))
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 9.5, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 9.5, main = "NOAA vs CCORE")
...
wc.image(wave_out_NOAA_CCORE, which.image = "wc", show.date = TRUE, 
         plot.arrow = FALSE, main = "NOAA vs CCORE")
# CCI vs CCORE also appears to have a much higher correlation than NOAA vs CCORE around period 1. 

```

\newpage
**Bundegi 08BND**
```{r Frequency_Analysis_Ningaloo_08BND, echo = FALSE, message = FALSE}
...
wave_out <- analyze.wavelet(Bundegi_08BND_joint_smooth, "ningaloo_CCI",
                            dt = 1/12,
                            dj = 1/10)
wt.image(wave_out, n.levels = 250,
         legend.params = list(lab = "wavelet power levels"),
...
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 12.5, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 12.5, main = "NOAA vs CCORE")
...
wc.image(wave_out_NOAA_CCORE, which.image = "wc", show.date = TRUE, 
         plot.arrow = FALSE, main = "NOAA vs CCORE")
# CCI vs CCORE also appears to have a similar correlation to NOAA vs CCORE at period 1. 
# NOAA vs CCORE shows significant correlation as compared to CCI vs CCORE which does not show correlation at period 2.
...
\newpage
**TNT07C**
```{r Frequency_Analysis_Ningaloo_TNT07C, echo = FALSE, message = FALSE}
...
wave_out <- analyze.wavelet(TNT07C_joint_smooth, "ningaloo_CCI",
                            dt = 1/10,
                            dj = 1/10)
wt.image(wave_out, n.levels = 250,
         legend.params = list(lab = "wavelet power levels"),
...
# cross-wavelet power (with certain limitations) to an assessment of the similarity of the two series’ wavelet power in the time-frequency (or time-scale) domain.
# NOAA vs CCORE and CCI vs CCORE shows very low power

par(mfrow=c(2,1))
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 3, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 3, main = "NOAA vs CCORE")
...
wc.image(wave_out_NOAA_CCORE, which.image = "wc", show.date = TRUE, 
         plot.arrow = FALSE, main = "NOAA vs CCORE")
#  NOAA vs CCORE shows significant correlation at period 0.5, whereas CCI vs CCORE shows no significant correlation.

```

\newpage
**BUN05A**
```{r Frequency_Analysis_Ningaloo_BUN05A, echo = FALSE, message = FALSE}
...
wave_out <- analyze.wavelet(BUN05A_joint_smooth, "ningaloo_CCI",
                            dt = 1,
                            dj = 1/10)
wt.image(wave_out, n.levels = 250,
         legend.params = list(lab = "wavelet power levels"),
...
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 6, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 6, main = "NOAA vs CCORE")
...
wc.image(wave_out_NOAA_CCORE, which.image = "wc", show.date = TRUE, 
         plot.arrow = FALSE, main = "NOAA vs CCORE")
#  NOAA vs CCORE shows significant correlation around period 0.4, whereas CCI vs CCORE significant correlation around period 2 and 5.

```

\newpage
**HAB05B**
```{r Frequency_Analysis_HAbrol_HAB05B, echo = FALSE, message = FALSE}
...
wave_out <- analyze.wavelet(HAB05B_SrCa_joint_smooth, "HAbrol_CCI",
                            dt = 1,
                            dj = 1/10)
wt.image(wave_out, n.levels = 250,
         legend.params = list(lab = "wavelet power levels"),
...
# cross-wavelet power (with certain limitations) to an assessment of the similarity of the two series’ wavelet power in the time-frequency (or time-scale) domain.
# CCI vs CCORE shows very low power whereas NOAA vs CCORE shows power 5 at period 0.3.
