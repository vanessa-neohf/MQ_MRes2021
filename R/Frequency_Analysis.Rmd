...
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 8.5, main = "CCI and CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 8.5, main = "NOAA and CCORE")
...
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 12.5, main = "CCI and CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 12.5, main = "NOAA and CCORE")
...
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 3, main = "CCI and CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 3, main = "NOAA and CCORE")
...
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 6, main = "CCI and CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 6, main = "NOAA and CCORE")
