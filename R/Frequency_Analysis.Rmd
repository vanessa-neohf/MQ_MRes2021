...
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = NULL, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = NULL, main = "NOAA vs CCORE")
...
wave_out_CCI_CCORE <- 
  analyze.coherency(Tantabiddi_13TNT_joint, 
...
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 11, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 11, main = "NOAA vs CCORE")
...
wave_out_CCI_CCORE <- 
  analyze.coherency(Tantabiddi_08TNT_joint, 
                    my.pair = c("ningaloo_CCI", "ningaloo_coral_core"),
                    loess.span = 0, 
                    dt = 1/12, dj = 1/10)
wc.avg(wave_out_CCI_CCORE, main = "CCI vs CCORE")
...
wave_out_CCI_CCORE <- 
  analyze.coherency(Bundegi_13BND_joint, 
                    my.pair = c("ningaloo_CCI", "ningaloo_coral_core"),
                    loess.span = 0, 
                    dt = 1/12, dj = 1/10)
wc.avg(wave_out_CCI_CCORE, main = "CCI vs CCORE")
...
wave_out_CCI_CCORE <- 
  analyze.coherency(Bundegi_08BND_joint, 
                    my.pair = c("ningaloo_CCI", "ningaloo_coral_core"),
                    loess.span = 0, 
                    dt = 1/12, dj = 1/10)
wc.avg(wave_out_CCI_CCORE, main = "CCI vs CCORE")
...
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 12, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 12, main = "NOAA vs CCORE")
...
wave_out_CCI_CCORE <- 
  analyze.coherency(TNT07C_joint, 
                    my.pair = c("ningaloo_CCI", "ningaloo_coral_core"),
                    loess.span = 0, 
                    dt = 1, dj = 1/10)
wc.avg(wave_out_CCI_CCORE, main = "CCI vs CCORE")
...
wave_out_CCI_CCORE <- 
  analyze.coherency(BUN05A_joint, 
                    my.pair = c("ningaloo_CCI", "ningaloo_coral_core"),
                    loess.span = 0, 
                    dt = 1, dj = 1/10)
wc.avg(wave_out_CCI_CCORE, main = "CCI vs CCORE")
...
par(mar = c(3, 4, 1, 2))
par(cex = 0.6)
wc.avg(wave_out_CCI_CCORE, maximum.level = 2, main = "CCI vs CCORE")
wc.avg(wave_out_NOAA_CCORE, maximum.level = 2, main = "NOAA vs CCORE")
...
wave_out_CCI_CCORE <- 
  analyze.coherency(HAB05B_SrCa_joint, 
