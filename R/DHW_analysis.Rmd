...
cols <- c("GCM" = "forest green", "CCI" = "red", "NOAA" = "dark blue")
```
...
ggplot(BRS05_Sat_Combined)+
  ...
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20, 40)) + #to standardise the y-axis
...
BRS07 <- ggplot(BRS07_Sat_Combined)+
   geom_rect(aes_string(xmin = as.Date(c("2016-01-01")), xmax = as.Date(c("2017-01-01")),
                ymin = -Inf, ymax = 40), color = "maroon", fill = "transparent", alpha = 0.5)+
  annotate("text", x = as.Date("2017-01-01"), y = Inf, label = "2016", hjust = 0, vjust = 1, size = 4)+
  annotate(geom = "text", x = as.Date("2027-01-01"), y = Inf, label = "(M)NOAA>CCI>GCM\n(S)NOAA>CCI>GCM", size = 3, vjust = 1)+
  geom_line(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type), alpha = 0.5, size = 1) +
  scale_x_date(limits = as_date(c("1985-01-01","2030-01-01")))+
  labs(x = "", y = "DHW", title = "(d) BRS07 (-14.12, 123.55)", subtitle = "Browse Island") +
  scale_color_manual(values = cols) +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20, 40)) + #to standardise the y-axis
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
DARL <- ggplot(DARL_Sat_Combined)+
  geom_rect(aes_string(xmin = as.Date(c("1996-01-01")), xmax = as.Date(c("1997-01-01")),
                ymin = -Inf, ymax = 40), color = "blue", fill = "transparent", alpha = 0.5)+
...
SCOTT_RPO_1 <- ggplot(SCOTT_RPO_1_Sat_Combined)+
  ...
  geom_line(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type), alpha = 0.5, size = 1) +
  scale_x_date(limits = as_date(c("1985-01-01","2030-01-01")))+
  labs(x = "", y = "DHW", title = "(b) SCOTT_RPO_1 (-14.06, 121.78)", subtitle = "Scott Reef") +
  scale_color_manual(values = cols) +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20, 40)) + #to standardise the y-axis
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
Tantabiddi <- ggplot(Tantabiddi_Sat_Combined)+
  ...
  annotate(geom = "text", x = as.Date("2027-01-01"), y = Inf, label = "(M)CCI>NOAA>GCM\n(S)NOAA>CCI>GCM", size = 3, vjust = 1)+
  geom_line(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type), alpha = 0.5, size = 1) +
  labs(x = "", y = "DHW", title = "(f) 08TNT, 13TNT (-21.91, 113.97)", subtitle = "Ningaloo Reef") +
  scale_x_date(limits = as_date(c("1985-01-01","2030-01-01")))+
  scale_color_manual(values = cols) +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20, 40)) + #to standardise the y-axis
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
...
HAB05B <- ggplot(HAB05B_Sat_Combined)+
  ...
  geom_line(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type), alpha = 0.5, size = 1) +
  scale_x_date(limits = as_date(c("1985-01-01","2030-01-01")))+
  labs(x = "Time", y = "DHW", title = "(h) HAB05B (-28.46, 113.77)", subtitle = "Houtman Abrolhos") +
  scale_color_manual(values = cols) +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20, 40)) + #to standardise the y-axis
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
        legend.key = element_rect(fill = "transparent"),
...
HAB10A <- ggplot(HAB10A_Sat_Combined)+
  ...
  annotate(geom = "text", x = as.Date("2027-01-01"), y = Inf, label = "(M)CCI>NOAA>GCM\n(S)CCI>NOAA>GCM", size = 3, vjust = 1)+
  geom_line(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type), alpha = 0.5, size = 1) +
  labs(x = "", y = "DHW", title = "(g) HAB10A (-28.46, 113.75)", subtitle = "Houtman Abrolhos") +
  scale_x_date(limits = as_date(c("1985-01-01","2030-01-01")))+
  scale_color_manual(values = cols) +
  scale_y_continuous(breaks = c(0, 4, 8, 12, 16, 20, 40)) + #to standardise the y-axis +
  theme(panel.grid.major.y = element_line(color = "grey", linetype = "dashed"),
...
DARL / SCOTT_RPO_1 / SCOTTSL1 / BRS07 

ggsave("DHW01.png", path = here::here("graphics/Figures"), dpi = 300, width = 210, height = 279, units = "mm", limitsize = FALSE)

Bundegi / Tantabiddi / HAB10A / HAB05B

ggsave("DHW02.png", path = here::here("graphics/Figures"), dpi = 300, width = 210, height = 279, units = "mm", limitsize = FALSE)
...
ggsave("Cumulative_DHW.png", path = here::here("graphics/Figures"), dpi = 300, width = 210, height = 297, units = "mm", limitsize = FALSE)
