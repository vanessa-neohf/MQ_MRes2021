...
ggplot(BRS05_Sat_Combined)+
  geom_point(aes(x = Date, y = accum_DHW_12weeks, color = Data_Type), alpha = 0.3) +
...
```{r DHW_Threshold, echo = FALSE}
#Bar Chart of yearly Moderate to High DHW values in CCI and NOAA
```
