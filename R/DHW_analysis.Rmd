...
```{r Cumulative_DHW_ts, echo=FALSE, message=FALSE, include=FALSE}

#DARL
DARL_cumu_HSdays <- DARL_Sat_Combined %>% 
  select(Date, accum_DHW_12weeks, Data_Type, Reef_Site) %>% 
  mutate(accum_DHW_12weeks = if_else(accum_DHW_12weeks > 0, 1, 0)) %>% 
  group_by(Data_Type) %>% 
  mutate(DHW_days_count = cumsum(accum_DHW_12weeks)) %>% 
  ungroup() %>% 
  select(-accum_DHW_12weeks)

ggplot(DARL_cumu_HSdays) + 
  geom_line(aes(x = Date, y = DHW_days_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative DHW days", title = "DAR Long", color = "Data Type") +
...
ggplot(SCOTT_RPO_1_cumu_HSdays) + 
  geom_line(aes(x = Date, y = DHW_days_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative DHW days", title = "SCOTT_RPO_1", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01"))) 
...
ggplot(SCOTTSL1_cumu_HSdays) + 
  geom_line(aes(x = Date, y = DHW_days_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative DHW days", title = "SCOTTSL1", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01"))) 
...
ggplot(BRS07_cumu_HSdays) + 
  geom_line(aes(x = Date, y = DHW_days_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative DHW days", title = "BRS07", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01"))) 
...
ggplot(Bundegi_cumu_HSdays) + 
  geom_line(aes(x = Date, y = DHW_days_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative DHW days", title = "Bundegi", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
...
ggplot(Tantabiddi_cumu_HSdays) + 
  geom_line(aes(x = Date, y = DHW_days_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative DHW days", title = "Tantabiddi", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
...
ggplot(HAB05B_cumu_HSdays) + 
  geom_line(aes(x = Date, y = DHW_days_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative DHW days", title = "HAB05B", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
...
ggplot(HAB10A_cumu_HSdays) + 
  geom_line(aes(x = Date, y = DHW_days_count, color = Data_Type)) + 
  labs(x = "Time", y = "Cumulative DHW days", title = "HAB10A", color = "Data Type") +
  scale_x_date(limits = as_date(c("1985-01-01","2021-01-01")))
